...
pub mod collection_service_server {
    ...
    pub const SERVICE_NAME: &str = "aruna.api.storage.services.v2.CollectionService";
...
pub mod storage_status_service_server {
    ...
    #[async_trait]
    pub trait StorageStatusService: std::marker::Send + std::marker::Sync + 'static {
        /// GetStorageVersion
        ///
        /// Status: BETA
        ///
    ...
    /// about the status of storage components
    #[derive(Debug)]
    pub struct StorageStatusServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> StorageStatusServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T> Clone for StorageStatusServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "aruna.api.storage.services.v2.StorageStatusService";
    impl<T> tonic::server::NamedService for StorageStatusServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
#[derive(serde::Deserialize, serde::Serialize)]
...
pub mod dataset_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "aruna.api.storage.services.v2.DatasetService";
...
pub mod data_replication_service_server {
    ...
    #[async_trait]
    pub trait DataReplicationService: std::marker::Send + std::marker::Sync + 'static {
        /// ReplicateProjectData
        ///
        /// Status: ALPHA
        ///
    ...
    /// Endpoint specific methods for syncing data
    #[derive(Debug)]
    pub struct DataReplicationServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> DataReplicationServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T> Clone for DataReplicationServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "aruna.api.storage.services.v2.DataReplicationService";
    impl<T> tonic::server::NamedService for DataReplicationServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
#[derive(serde::Deserialize, serde::Serialize)]
...
pub mod project_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "aruna.api.storage.services.v2.ProjectService";
...
pub mod endpoint_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "aruna.api.storage.services.v2.EndpointService";
...
pub mod authorization_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "aruna.api.storage.services.v2.AuthorizationService";
...
pub mod service_account_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "aruna.api.storage.services.v2.ServiceAccountService";
...
pub mod license_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "aruna.api.storage.services.v2.LicenseService";
...
impl ReferenceType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            Self::User => "REFERENCE_TYPE_USER",
            Self::Resource => "REFERENCE_TYPE_RESOURCE",
        }
    }
...
impl PersonalNotificationVariant {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Unspecified => "PERSONAL_NOTIFICATION_VARIANT_UNSPECIFIED",
            Self::AccessRequested => "PERSONAL_NOTIFICATION_VARIANT_ACCESS_REQUESTED",
            Self::PermissionGranted => "PERSONAL_NOTIFICATION_VARIANT_PERMISSION_GRANTED",
            Self::PermissionRevoked => "PERSONAL_NOTIFICATION_VARIANT_PERMISSION_REVOKED",
            Self::PermissionUpdated => "PERSONAL_NOTIFICATION_VARIANT_PERMISSION_UPDATED",
            Self::Announcement => "PERSONAL_NOTIFICATION_VARIANT_ANNOUNCEMENT",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
pub mod user_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "aruna.api.storage.services.v2.UserService";
...
pub mod object_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "aruna.api.storage.services.v2.ObjectService";
...
pub mod workspace_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "aruna.api.storage.services.v2.WorkspaceService";
...
pub mod relations_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "aruna.api.storage.services.v2.RelationsService";
...
pub mod rules_service_server {
    ...
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with RulesServiceServer.
    #[async_trait]
    pub trait RulesService: std::marker::Send + std::marker::Sync + 'static {
        /// CreateRule
        ///
        /// Status: ALPHA
        ///
    ...
    /// Contains all methods to edit and change rules
    #[derive(Debug)]
    pub struct RulesServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> Clone for RulesServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "aruna.api.storage.services.v2.RulesService";
    impl<T> tonic::server::NamedService for RulesServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
#[derive(serde::Deserialize, serde::Serialize)]
...
pub mod search_service_server {
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "aruna.api.storage.services.v2.SearchService";
