...
pub mod bundler_service_server {
    ...
    #[async_trait]
    pub trait BundlerService: std::marker::Send + std::marker::Sync + 'static {
        /// CreateBundle
        ///
        /// Status: ALPHA
        ///
    ...
    /// Dataproxy specific service for creating and deleting bundles.
    #[derive(Debug)]
    pub struct BundlerServiceServer<T> {
        inner: Arc<T>,
    ...
    impl<T> Clone for BundlerServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "aruna.api.dataproxy.services.v2.BundlerService";
    impl<T> tonic::server::NamedService for BundlerServiceServer<T> {
...
pub struct PullReplicationResponse {
    #[prost(oneof = "pull_replication_response::Message", tags = "5, 1, 2, 3, 4")]
...
impl ReplicationStatus {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            Self::Pending => "REPLICATION_STATUS_PENDING",
...
pub mod dataproxy_replication_service_client {
    ...
    impl DataproxyReplicationServiceClient<tonic::transport::Channel> {
        /// Attempt to create a new client by connecting to a given endpoint.
        pub async fn connect<D>(dst: D) -> Result<Self, tonic::transport::Error>
        where
            D: TryInto<tonic::transport::Endpoint>,
...
pub mod dataproxy_replication_service_server {
    ...
    #[async_trait]
    pub trait DataproxyReplicationService: std::marker::Send + std::marker::Sync + 'static {
    ...
    /// Service for data replication between data-proxies
    #[derive(Debug)]
    pub struct DataproxyReplicationServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> DataproxyReplicationServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T> Clone for DataproxyReplicationServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "aruna.api.dataproxy.services.v2.DataproxyReplicationService";
    impl<T> tonic::server::NamedService for DataproxyReplicationServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Generated server implementations.
pub mod dataproxy_backend_service_server {
    ...
    #[async_trait]
    pub trait DataproxyBackendService: std::marker::Send + std::marker::Sync + 'static {
        async fn put_object(
            &self,
    ...
    #[derive(Debug)]
    pub struct DataproxyBackendServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> DataproxyBackendServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T> Clone for DataproxyBackendServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "aruna.api.dataproxy.services.v2.DataproxyBackendService";
    impl<T> tonic::server::NamedService for DataproxyBackendServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Generated server implementations.
pub mod dataproxy_user_service_server {
    ...
    #[async_trait]
    pub trait DataproxyUserService: std::marker::Send + std::marker::Sync + 'static {
        /// GetCredentials
        ///
        /// Status: BETA
        ///
    ...
    #[derive(Debug)]
    pub struct DataproxyUserServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> DataproxyUserServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T> Clone for DataproxyUserServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "aruna.api.dataproxy.services.v2.DataproxyUserService";
    impl<T> tonic::server::NamedService for DataproxyUserServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Generated server implementations.
pub mod dataproxy_ingestion_service_server {
    ...
    #[async_trait]
    pub trait DataproxyIngestionService: std::marker::Send + std::marker::Sync + 'static {
        /// IngestExistingObject
        ///
        /// Status: ALPHA
        ///
    ...
    #[derive(Debug)]
    pub struct DataproxyIngestionServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> DataproxyIngestionServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T> Clone for DataproxyIngestionServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "aruna.api.dataproxy.services.v2.DataproxyIngestionService";
    impl<T> tonic::server::NamedService for DataproxyIngestionServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
